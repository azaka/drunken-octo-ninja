...
process_url() {
	...
	ffmpeg -i $in_file -threads 4 -s 640x360 -tune animation -q -1 -c:a copy $out_file
...
travis_script() {
	file_from_url \
	v12 https://lh3.googleusercontent.com/tuR7Esx4DCY-Qo7YJ5hFx6sJCvoq2ch6q6zRYUWdS0lthGgwnGv3rDS89UCZvsSrD5Ha=m22
}
